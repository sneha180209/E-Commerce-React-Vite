...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_dJKiw2dJJO6Irc",
      key_secret: "oRgHOXd9JocwcAb5dGj1P51j",
  ...
  <img src="https://imageupload.io/ib/bdWYLYuLv4EXhtG_1696777946.png" alt="c60fea3ac3aab2e82c2f7ea901ef55f6-removebg-preview.png" />
  {/* <p className='text-lg font-bold text-gray-500' style={{ fontSize: '25px', marginLeft: '20px', marginTop:"-50px" }}>Cart is Empty</p> */}
</div>
)}
</div>
